...
//         <p className="text-xl font-medium text-gray-600 dark:text-gray-300 mb-1">
//           {data.weather[0].main}
//         </p>
...
//           className={`px-4 py-2 ${isFavorite ? 'bg-red-600 hover:bg-red-700' : 'bg-green-600 hover:bg-green-700'} text-white rounded transition text-sm mt-4`}
//         >
...
//             <div key={index} className="flex flex-col items-center bg-blue-50 dark:bg-zinc-800 rounded-lg px-3 py-2 min-w-[75px]">
...
//                 height={40}
//               />
//                <p className="text-sm text-gray-700 dark:text-gray-200 font-medium">{Math.round(day.main.temp)}°C</p>
//             </div>
//           ))}
//         </div>
...
//             <div
//               key={index}
//               className="flex flex-col items-center bg-blue-50 dark:bg-zinc-800 rounded-lg px-3 py-2 min-w-[75px]"
//             >
//               <p className="text-xs text-gray-500 dark:text-gray-400">
